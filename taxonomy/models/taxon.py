...
from taxonomy.settings import BASECATEGORY_MIXIN, TAXONRANK_SEPARATOR, TAXONOMY_SITES_POLICY
...
class BaseTaxon(SITE_POLICY_MODEL_MIXIN, MPTTModel):
...
if BASECATEGORY_MIXIN:
    Mixin = get_basemodel_mixin(BASECATEGORY_MIXIN):
